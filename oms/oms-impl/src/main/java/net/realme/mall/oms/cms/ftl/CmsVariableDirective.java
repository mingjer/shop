 ...
 */
@Component
public class CmsVariableDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env,
        ...
        CmsComponentDto cmsComponentDto = cmsComponentService.get(CmsComponentTypeEnum.TYPE_VARIABLE.getValue(), name, siteCode);
