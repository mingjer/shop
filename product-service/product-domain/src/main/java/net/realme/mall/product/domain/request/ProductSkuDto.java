 ...
 *
 * @author 91000044
 * @date 2018/8/23 10:47
 */
public class ProductSkuDto implements Serializable {

    private static final long serialVersionUID = 1937823568344928859L;
    ...
    /**
     * 获取状态：0-正常-上架，1-不可用-已下架
     *
     * @return status - 状态：0-正常-上架，1-不可用-已下架
     */
    ...
    /**
     * 设置状态：0-正常-上架，1-不可用-已下架
     *
     * @param status 状态：0-正常-上架，1-不可用-已下架
     */
